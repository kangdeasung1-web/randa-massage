  ...
  return (
    ...
    >
      ...
      <section 
        ...
        id="hero-banner"
      >
        <div className="w-full max-w-[1440px] mx-auto px-4 lg:px-14 h-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 lg:gap-10 items-center">
          ...
          <motion.div
            ...
            className="order-1 lg:order-2 relative h-[380px] xs:h-[440px] sm:h-[480px] lg:h-[600px] w-full max-w-[480px] lg:max-w-full lg:w-full lg:ml-auto mx-auto overflow-hidden rounded-[20px] border border-[#2C2C2C] bg-[#0B0B0B] group hover:border-[#E63946] hover:shadow-[0_8px_30px_rgba(193,18,31,0.18)] hover:-translate-y-1 transition-all duration-300"
          >
            ...
            <div className="w-full h-full overflow-hidden relative flex items-center justify-center bg-[#121212]">
              <img
                ...
                loading="eager"
                fetchPriority="high"
                className="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-500 ease-out select-none filter brightness-105 saturate-105"
          ...
          >
            ...
            >
              <div className="flex flex-col sm:flex-row flex-1 items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 sm:pr-2">
                <span className="premium-icon-wrapper shrink-0">
                  <ShieldCheck className="premium-icon" />
                </span>
                <div className="text-center sm:text-left">
                  <h4 className="text-sm font-bold text-[#F8F8F8] leading-none whitespace-nowrap">예약금 없는 후불제</h4>
              ...
              <div className="flex flex-col sm:flex-row flex-1 items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 sm:px-3">
                <span className="premium-icon-wrapper shrink-0">
                  <Clock3 className="premium-icon" />
                </span>
                <div className="text-center sm:text-left">
                  <h4 className="text-sm font-bold text-[#F8F8F8] leading-none whitespace-nowrap">24시간 상담</h4>
                  <p className="text-xs text-[#A8A8A8] mt-1.5 whitespace-nowrap">언제든지 편안하게</p>
                </div>
              </div>
              <div className="hidden sm:block w-[1px] bg-[#2C2C2C] self-stretch my-1" />
              
              <div className="flex flex-col sm:flex-row flex-1 items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 sm:pl-3">
                <span className="premium-icon-wrapper shrink-0">
                  <MapPin className="premium-icon" />
                </span>
                <div className="text-center sm:text-left">
                  <h4 className="text-sm font-bold text-[#F8F8F8] leading-none whitespace-nowrap">{activeRegionData.name.replace("출장마사지", "") || "시흥"} 전지역 방문</h4>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 md:px-14">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 items-stretch">
            ...
            {/* Column 1 */}
            <div className="bg-[#181818] border border-[#2C2C2C] hover:border-[#C1121F] rounded-[20px] p-6 sm:p-8 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-[4px] relative group/trust-card h-full justify-start shadow-sm overflow-hidden min-h-[220px] md:min-h-[245px]">
              <div className="flex flex-col items-center w-full">
                ...
                <span className="text-base sm:text-lg font-bold text-[#F8F8F8] tracking-tight mb-2 leading-none block break-keep whitespace-nowrap">
                  프리미엄 관리사
                </span>
                <p className="text-[#A8A8A8] leading-relaxed font-sans break-keep max-w-[220px] mx-auto group-hover/trust-card:text-[#F8F8F8] transition-colors" style={{ fontSize: "clamp(12px, 3.4vw, 14px)", wordBreak: "keep-all", overflowWrap: "break-word" }}>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between p-6 md:p-10 bg-[#181818]/80 backdrop-blur-md rounded-[24px] border border-white/[0.06] shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative overflow-hidden group">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2.5">
                  <h3 
                    className="text-lg md:text-xl font-bold text-[#F8F8F8] tracking-tight leading-snug"
                    style={{ wordBreak: 'keep-all', overflowWrap: 'break-word' }}
                  >
                    <span className="inline-block whitespace-nowrap mr-1.5">시흥 전 지역 및 인근 지역</span>
                    <span className="inline-block whitespace-nowrap"><span className="text-[#E63946]">30분 내</span> 신속 방문</span>
                  </h3>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-5 gap-2">
                    {MAJOR_REGIONS_MAP.map((item, idx) => (
                      <a 
                        ...
                        className="h-[38px] flex items-center justify-center rounded-[10px] bg-white/[0.02] border border-white/[0.06] font-sans font-medium text-[#D0D0D0] hover:text-[#E63946] hover:border-[#E63946]/30 hover:bg-[#E63946]/5 hover:shadow-[0_4px_12px_rgba(230,57,70,0.12)] hover:scale-[1.03] transition-all duration-300 cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis px-1.5"
              ...
              <div className="pt-5 mt-5 border-t border-white/[0.05] relative z-10">
                <button
                  ...
                  className="w-full h-[52px] rounded-[14px] bg-gradient-to-r from-[#C1121F] to-[#E63946] text-[#FFFFFF] font-sans font-bold tracking-wide hover:shadow-[0_12px_30px_rgba(193,18,31,0.25)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
