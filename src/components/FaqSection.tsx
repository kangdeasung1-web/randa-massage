    ...
    <section className="pt-12 pb-16 md:pt-14 md:pb-24 bg-[#121212] border-t border-[#2C2C2C] relative overflow-hidden" id="premium-faqs-section">
      <div className="max-w-[1440px] mx-auto px-6 md:px-14">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-[11px] xs:text-sm md:text-base text-[#A8A8A8] whitespace-nowrap">
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span 
                    className={`font-sans font-semibold tracking-tight transition-colors duration-200 ${isOpen ? 'text-[#E63946]' : 'text-[#F8F8F8] group-hover:text-[#E63946]'}`}
                    style={{ fontSize: "clamp(13px, 3.8vw, 16px)", wordBreak: "keep-all", overflowWrap: "break-word" }}
                  >
                    {faq.q}
                  </span>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div 
                        className="px-6 pb-6 sm:px-8 sm:pb-6 text-[#A8A8A8] leading-relaxed font-sans border-t border-[#2C2C2C] pt-4 font-light"
                        style={{ fontSize: "clamp(12px, 3.4vw, 14px)", wordBreak: "keep-all", overflowWrap: "break-word" }}
                      >
                        {faq.a}
                      </div>
                    </motion.div>
